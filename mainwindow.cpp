...
void HReportMainWindow::createCategoryMain(SARibbonCategory *page)
{
    ...
    //字体颜色
    QPixmap pix1(QSize(40,40));
    pix1.fill(QColor(Qt::black));
    QAction* blackAct1 = new QAction(QIcon(pix1),QStringLiteral("黑色"));
    blackAct1->setData(QVariant("#000000"));
    pix1.fill(QColor(Qt::white));
    QAction* whiteAct1 = new QAction(QIcon(pix1),QStringLiteral("白色"));
    whiteAct1->setData(QVariant("#ffffff"));
    pix1.fill(QColor(Qt::red));
    QAction* redAct1 = new QAction(QIcon(pix1),QStringLiteral("红色"));
    redAct1->setData(QVariant("#ff0000"));
    pix1.fill(QColor(Qt::green));
    QAction* greenAct1 = new QAction(QIcon(pix1),QStringLiteral("绿色"));
    greenAct1->setData(QVariant("#00ff00"));
    pix1.fill(QColor(Qt::blue));
    QAction* blueAct1 = new QAction(QIcon(pix1),QStringLiteral("蓝色"));
    blueAct1->setData(QVariant("#0000ff"));
    pix1.fill(QColor(Qt::yellow));
    QAction* yellowAct1 = new QAction(QIcon(pix1),QStringLiteral("黄色"));
    yellowAct1->setData(QVariant("#ffff00"));
    pix1.fill(QColor(Qt::darkRed));
    QAction* darkRedAct1 = new QAction(QIcon(pix1),QStringLiteral("深红色"));
    darkRedAct1->setData(QVariant("#800000"));
    pix1.fill(QColor(Qt::darkGreen));
    QAction* darkGreenAct1 = new QAction(QIcon(pix1),QStringLiteral("深绿色"));
    darkGreenAct1->setData(QVariant("#008000"));
    pix1.fill(QColor(Qt::darkBlue));
    QAction* darkBlue1 = new QAction(QIcon(pix1),QStringLiteral("深绿色"));
    darkBlue1->setData(QVariant("#000080"));
    pix1.fill(QColor(Qt::cyan));
    QAction* cyanAct1 = new QAction(QIcon(pix1),QStringLiteral("蓝绿色"));
    cyanAct1->setData(QVariant("#00ffff"));


    SARibbonMenu* clrmenu2 = new SARibbonMenu(this);
    fontColorActGroup = new QActionGroup(this);
    clrmenu2->addAction(blackAct1);
    fontColorActGroup->addAction(blackAct1);
    clrmenu2->addAction(whiteAct1);
    fontColorActGroup->addAction(whiteAct1);
    clrmenu2->addAction(redAct1);
    fontColorActGroup->addAction(redAct1);
    clrmenu2->addAction(greenAct1);
    fontColorActGroup->addAction(greenAct1);
    clrmenu2->addAction(blueAct1);
    fontColorActGroup->addAction(blueAct1);
    clrmenu2->addAction(yellowAct1);
    fontColorActGroup->addAction(yellowAct1);
    clrmenu2->addAction(darkRedAct1);
    fontColorActGroup->addAction(darkRedAct1);
    clrmenu2->addAction(darkGreenAct1);
    fontColorActGroup->addAction(darkGreenAct1);
    clrmenu2->addAction(darkBlue1);
    fontColorActGroup->addAction(darkBlue1);
    clrmenu2->addAction(cyanAct1);
    fontColorActGroup->addAction(cyanAct1);
